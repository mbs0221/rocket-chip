...
class CSRFile(
  ...
  /** U-mode Branch Context Store (BCS)
    * see [[BCSConfig]]
    */
  ...
  /** V-extension
    * see [[VConfig]] v-{config, start, xsat, xrm}
    */
